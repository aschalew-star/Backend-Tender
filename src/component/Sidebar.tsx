      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">{tender.region?.name || 'Not specified'}</p>
          </div>
        </div>
          ...
          <>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">{formatDate(tender.approvedAt)}</p>
              </div>
            </div>
          </>
        )}
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-white rounded-lg border border-gray-200">
              ...
              <span className="font-medium text-gray-900">
                {tender.postedBy ? `${tender.postedBy.firstName} ${tender.postedBy.lastName}` : 'System'}
              </span>
            </div>
            ...
            <div className="flex justify-between items-center p-3 bg-white rounded-lg border border-gray-200">
              ...
              <span className="font-medium text-gray-900">
                {tender.approvedBy ? `${tender.approvedBy.firstName} ${tender.approvedBy.lastName}` : 'Pending'}
              </span>
            </div>
            ...
            <div className="flex justify-between items-center p-3 bg-white rounded-lg border border-gray-200">
              ...
              <span className="font-medium text-gray-900">
                {tender.approvedAt ? formatDate(tender.approvedAt) : 'Pending'}
              </span>
            </div>

            <div className="flex justify-between items-center p-3 bg-white rounded-lg border border-gray-200">
              <span className="text-gray-600">Documents</span>
              <span className="font-medium text-gray-900">{tender.tenderDocs.length} files</span>
            </div>
          </div>
        </div>
      </CardContent>
